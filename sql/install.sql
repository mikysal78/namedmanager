...
--
INSERT INTO `users` (`id`, `username`, `realname`, `password`, `password_salt`, `contact_email`, `time`, `ipaddress`) VALUES (1, 'admin', 'SysAdmin', 'e86b576fa4b968b283088c91daf62e8499fb1ca1', 'dxzvxz8e9qsg88qqi8cb', 'admin@dns.nnxx', 0, '');
...
GRANT USAGE ON * . * TO 'namedmanager'@'%' IDENTIFIED BY 'ninux' WITH MAX_QUERIES_PER_HOUR 0 MAX_CONNECTIONS_PER_HOUR 0 MAX_UPDATES_PER_HOUR 0;
